  ...
  <main id="main">
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <c:choose>
        	<c:when test="${product.getCategory_code() =='의류1'}"><div class="col-lg-4 col-md-6 portfolio-item filter-top"></c:when>
        	<c:when test="${product.getCategory_code() =='의류2'}"><div class="col-lg-4 col-md-6 portfolio-item filter-bottom"></c:when>
            ...
            <div class="portfolio-wrap">
              <img src="${product.getPro_img() }" class="img-fluid" alt="">
               <div class="portfolio-info">
                ...
                <a href="detailProduct.do?p_num=${product.getPro_num()}"><i class="fa fa-plus"></i>상세보기</a>
                <a href="addCart.do?p_num=${product.getPro_num()}"><i class="fa fa-cart-plus"></i>카트에 담기</a>
               </div>
              </div>
            </div>
		</c:forEach>
